...
# Package       : ruby_dep
# Version       : v1.5.0
# Source repo   : https://github.com/e2/ruby_dep
# Tested on     : UBI 8.4
...
PACKAGE_NAME=ruby_dep
PACKAGE_VERSION=${1:-v1.5.0}
PACKAGE_URL=https://github.com/e2/ruby_dep
...
function test_with_ruby(){
	...
	#Require tmpdir in the warnings.rb file
	sed -i "2s/.*/require 'tmpdir'/" /home/tester/ruby_dep/spec/acceptance/warnings_spec.rb
